// pages/tempperson/tempperson.js
var form_data;
var app = getApp();
Page({
  ...
  formSubmit: function (e) {
    ...
    this.setData({
      ...
      people_number: e.detail.value.people_number,
      note: e.detail.value.note,
    })
    var url = "https://www.messj.xyz/api/peopleappoint/test";
    wx.request({
      url: url,
      method: "POST",
      data: {
        ...
        "usr_phone": e.detail.value.usr_phone,
        "people_name": e.detail.value.people_name,
        "people_phone": e.detail.value.people_phone,
        "people_number": e.detail.value.people_number,
        "date": that.data.date,
        "time": that.data.time,
